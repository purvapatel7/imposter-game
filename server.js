...
const rooms = {};
const words = ['Apple', 'Banana', 'Cherry', 'Date', 'Elderberry','strawberry','grape','watermelon','orange','pineapple','mango','kiwi','blueberry','raspberry','blackberry','lime','lemon','coconut','papaya','passionfruit','guava','pomegranate','pear','peach','plum','quince','fig','grapefruit','guava','kiwi','lime','mango','nectarine','papaya','passionfruit','peach','pear','pineapple','plum','pomegranate','quince','raspberry','watermelon',];
